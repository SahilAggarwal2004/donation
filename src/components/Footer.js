            ...
            <div className='grid grid-flow-row sm:grid-cols-3  my-10 mx-4 sm:mx-12 md:mx-20 gap-8 sm:gap-4  '>
                ...
                <Link to="/" >
                    <div className='flex gap-2 sm:flex-col items-center sm:items-start'>
                        ...
                        <p className='block  '>DoNations is an independent Not for Profit Organisation founded in 2022 by college students in order to do something valuable and good for the society. </p>
                    </div>
                </Link>
